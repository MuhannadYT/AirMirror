...
void video_renderer_set_parent_hwnd(unsigned long long parent);
int  video_renderer_get_audio_track_count();
int  video_renderer_get_current_audio_track();
int  video_renderer_get_audio_track_label(int index, char *out, int out_len);
void video_renderer_set_audio_track(int index);
